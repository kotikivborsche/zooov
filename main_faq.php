...
<section class="faq" id="faq">
        <div class="container">
        <h2 class="faq-title faq-title__faq">Частые вопросы</h2>
             <div class="faq-container">
                ...
                <div class="faq-qutstions">
                    ...
                    ?>
                    <div class="faq-question__faq">
                        <div class="faq-question__header__faq">
                            <h2 class="faq-question__text"><?php echo $row['question']; ?></h2>
                            
                        </div>
                        <div class="faq-question__answer__faq "><?php echo $row['answer']; ?></div>
                    </div>
